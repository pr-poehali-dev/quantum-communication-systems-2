...
const advantages = [
  {
    ...
    description:
      "Реалистичные модели инфраструктурных объектов для анализа и визуализации проектных решений. Поверхности TIN, Grid, Cropped, Corridor — полный набор для любых задач.",
    pills: ["TIN", "Grid", "Cropped", "Corridor"],
  },
  {
    icon: "Puzzle",
