...
Аналог Autodesk Civil 3D, реализованный на русском языке с поддержкой всех отечественных норм (СП, ГОСТ).`,
      },
      {
...
Введите название проекта и нажмите «Создать».`,
      },
      {
        ...
        content: `В левой боковой панели перечислены все 18 модулей программы. Кликните на нужный для начала работы. Вы также можете открыть ЛАПА — Редактор для полного аналога интерфейса AutoCAD Civil 3D.`,
      },
      {
...
Кнопка 💾 в верхней панели сохраняет проект в базу данных. Открыть сохранённые проекты можно через кнопку 🗁 или «Открыть…».`,
        tip: "Все форматы открываются в AutoCAD, Revit, Civil 3D, QGIS и других программах.",
      },
    ],
  },
  {
...
• LandXML — для Civil 3D, InfraWorks, ЛАПА 3D
